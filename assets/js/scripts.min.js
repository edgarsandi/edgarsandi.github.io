...
$('.entry-reading-time-content').each(function (index, element){
    var txt = $('.entry-content:eq('+index+')').text();
    words = txt.replace( /[^\w ]/g, "" ).split( /\s+/ ).length;
	words_per_minute = 150

	minutes = Math.ceil(( words / words_per_minute ));
	minutes_label = minutes === 1 ? " minute" : " minutes";
	minutes = minutes > 0 ? "about " + minutes + " " + minutes_label + " " : "less than 1 minute";
